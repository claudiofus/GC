...
public enum RegimeFiscaleType {
    ...
    /**
     * Regime dei contribuenti minimi (art. 1,c.96-117,
     * 						L. 244/2007)
     * 
     */
    @XmlEnumValue("RF02")
    ...
    /**
     * Agricoltura e attività connesse e pesca (artt. 34
     * 						e 34-bis, D.P.R. 633/1972)
     * 
     */
    @XmlEnumValue("RF04")
    RF_04("RF04"),
    ...
    /**
     * Vendita sali e tabacchi (art. 74, c.1, D.P.R.
     * 						633/1972)
     * 
     */
    @XmlEnumValue("RF05")
    ...
    /**
     * Commercio dei fiammiferi (art. 74, c.1, D.P.R.
     * 						633/1972)
     * 
     */
    @XmlEnumValue("RF06")
    ...
    /**
     * Gestione di servizi di telefonia pubblica (art.
     * 						74, c.1, D.P.R. 633/1972)
     * 
     */
    @XmlEnumValue("RF08")
    RF_08("RF08"),
    ...
    /**
     * Rivendita di documenti di trasporto pubblico e di
     * 						sosta (art. 74, c.1, D.P.R. 633/1972)
     * 
     */
    @XmlEnumValue("RF09")
    RF_09("RF09"),
    ...
    /**
     * Intrattenimenti, giochi e altre attività di cui
     * 						alla tariffa allegata al D.P.R. 640/72 (art. 74, c.6, D.P.R.
     * 						633/1972)
     * 					
     * 
     */
    ...
    /**
     * Agenzie di viaggi e turismo (art. 74-ter, D.P.R.
     * 						633/1972)
     * 
     */
    @XmlEnumValue("RF11")
    ...
    /**
     * Vendite a domicilio (art. 25-bis, c.6, D.P.R.
     * 						600/1973)
     * 
     */
    @XmlEnumValue("RF13")
    ...
    /**
     * Rivendita di beni usati, di oggetti d’arte,
