...
public class Utils {
	...
	public static boolean containsRifLinea(final List<DDT> ddts) {
	...
	public static boolean containsDDT(final List<DDT> list, final String number, final int provider_id) {
		for (DDT ddt : list) {
