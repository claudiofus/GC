...
public class EInvoiceDaoImpl implements Dao<EInvoice> {
	...
	public Provider checkProvider(EInvoice einv) {
		...
		if (!providerName.isEmpty()) {
			List<Provider> providers = prImpl.getAll();
			if (!Utils.containsProvName(providers, providerName)) {
	...
	@Override
	public List<EInvoice> getAll() {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public void save(EInvoice einvoice) {
		Provider provider = checkProvider(einvoice);

		try {
			int id = DBInvoice.insertInvoice(conn, einvoice, provider.getId());
			einvoice.setId(id);
			conn.commit();
		} catch (SQLException e) {
	...
	@Override
	public void update(EInvoice t, String[] params) {
		// TODO Auto-generated method stub

	}

	@Override
	public void delete(EInvoice t) {
		// TODO Auto-generated method stub

	}

	public List<EInvoice> getAll(Provider provider) {
